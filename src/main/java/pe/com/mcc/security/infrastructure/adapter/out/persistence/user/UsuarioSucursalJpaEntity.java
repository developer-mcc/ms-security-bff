...
@NoArgsConstructor
@Entity
@Table(schema = "sec", name = "usuarios_sucursales")
public class UsuarioSucursalJpaEntity {

  @EmbeddedId private UsuarioSucursalId id;
  ...
  private SucursalJpaEntity sucursal;
